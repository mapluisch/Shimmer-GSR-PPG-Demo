...
namespace ShimmeringUnity
{
    ...
    public class ShimmerDevice : MonoBehaviour
    {
        ...
        private string devName = "Shimmer3-2378";
        ...
        private ShimmerConfig.SensorBitmap enabledSensors = ShimmerConfig.SensorBitmap.SENSOR_GSR & ShimmerConfig.SensorBitmap.SENSOR_INT_A13;
